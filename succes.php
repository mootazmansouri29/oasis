...
<html lang="fr">
   <head>     
      ...
      <link href="css/succes.css" rel="stylesheet" />
    </head>
  <body>
  <div class="wrapper">
	<div class="screen">
		...
		<p class="message">Enregistrement effectué avec succès.!</p>
        <button class="button" onclick="window.open('Acceuil.php', '_self');">Done</button>
	</div>
</div>
